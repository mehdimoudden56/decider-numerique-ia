...
!!! note "Le test de la reformulation"
    Un outil simple pour vérifier que vous avez bien compris un concept technique : après une explication, reformulez dans vos propres mots ce que vous avez compris, et demandez à votre interlocuteur de confirmer ou de corriger.
    Si vous ne pouvez pas reformuler ce qu’on vient de vous expliquer, c’est que l’explication n’a pas été suffisamment claire, ou que vous n’avez pas encore assez de contexte pour l’assimiler. La bonne réaction n’est jamais d’acquiescer poliment : c’est de demander une reformulation.
    Tout professionnel SI compétent doit être capable d’expliquer n’importe quel concept en langage accessible. Si ce n’est pas le cas, c’est un signal sur la culture de communication de l’équipe SI.
