...
C’est l’article de décembre 2021 qui posait déjà quatre critères de qualité de la donnée. Leur formulation a évolué depuis vers celle, plus opérationnelle, retenue dans le livre, que je présente dans la page [Les quatre critères de qualité des données](../concepts-originaux/qualite-donnees-quatre-criteres.md).
