...
C’est pourtant cette posture qui sépare l’expertise de la décision, le principe que je tiens pour le plus mal appliqué du management du numérique, et que développe la deuxième des [sept convictions](../concepts-originaux/sept-convictions.md) du livre.
